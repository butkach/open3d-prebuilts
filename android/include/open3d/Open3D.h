...
// Tensor (`t/`) and dataset-download modules are excluded from core-only
// (Android TSDF) builds; these headers do not exist there.
...
#ifndef OPEN3D_BUILD_CORE_ONLY
// Visualization/GUI stack excluded from core-only (Android TSDF) builds.
